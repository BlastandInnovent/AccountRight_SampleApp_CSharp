//  File:        RecordDoesNotExistsException.cs
...
namespace CSharpSamples.Common.Exceptions
{
    ...
    {
        private const string _exceptionMessage = "Record does not exist";
        ...
        public RecordDoesNotExistsException(Exception ex)
            : base(_exceptionMessage, ex)
        {
        }
    }
}
